...
// Project				:	CityRPG
// Author				:	/Ty
// Description				:	Moderator Jets Code file
// ============================================================

$CityRPG::jobs::name = "Moderator Jets";
$CityRPG::jobs::type = "mod";
$CityRPG::jobs::initialInvestment = 0;
$CityRPG::jobs::pay = 100;
$CityRPG::jobs::tools = "";
$CityRPG::jobs::datablock = PlayerFuelJet;
...
$CityRPG::jobs::helpline = "\c6Has jets, can sell items, can use police and criminal cars, can pardon, & can thief.";
